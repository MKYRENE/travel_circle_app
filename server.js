...
const map_api_routes = require("./controllers/map_api");
const post_routes = require("./controllers/post_routes");
const user_routes = require("./controllers/user_routes");
const view_routes = require("./controllers/view_routes");
const weather_api_routes = require("./controllers/weather_api_routes");
...
// Load Routes
app.use("/", [api_routes, map_api_routes, post_routes, user_routes, view_routes, weather_api_routes]);
