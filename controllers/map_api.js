...
(function () {
    ...
    var map = new mapboxgl.Map({
        ...
        center: [-95.7129, 37.0902], // Set the initial center of the map to longitude -95.7129 and latitude 37.0902
        ...
        fetch(geocoder)
            ...
            .then(data => {
                if (data.features.length > 0) {
                    ...
                    // If no location is found, display an alert to the user
